/****************************************************************************
** Meta object code from reading C++ file 'okienko.h'
**
...
#error "The header file 'okienko.h' doesn't include <QObject>."
...
const QMetaObject Okienko::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Okienko.data,
      qt_meta_data_Okienko,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Okienko::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Okienko.stringdata0))
